...
Thus far, the measurements have only concerned line-integrated densities. This
is a consequence of the use of laser absorption spectroscopy. There are several
approaches which may be used to ascertain actual densities and radial density
maps of the \acs{rpnd}. One of the more common approaches is the use of an Abel
inversion. This is a mathematical technique which can reconstruct the density
distribution from measurements along several chords of a cylindrically symmetric
system. 
