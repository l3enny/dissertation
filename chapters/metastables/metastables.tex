...
the 2$^3$S$_1$-2$^3$P$_0^\mathrm{o}$ transition. The absorption spectra were
measured for time domains of $-300$-$1700$ ns relative to the voltage pulse.
Additional measurements were made at the midstream position of the metastable
densities from $-88$-$712$ $\mu$s in order to investigate the loss mechanisms of
the metastables.
...
Several measures were required in order to limit the impact of the broadband
electronic noise associated with the fast pulses. To some extent, the ground
shell of the discharge apparatus helped to mitigate the 
