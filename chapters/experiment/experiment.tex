...
\begin{figure}
  ...
  \label{fig:appschem}
\end{figure}
is a illustration of a vertical cross section of the discharge geometry.

As mentioned, the discharge was formed between two electrodes. The electrodes
were Conflat flanges on opposite sides of a borosilicate glass tube. The plasma
was generated inside the glass tube after it had been evacuated of air and
filled with the desired pressure of helium. The tube had an inner diameter of
3.3 cm, an outer diameter of 4.0 cm, and a length of 22.9 cm. The overall length
of the tube with the flanges was 30 cm. In the figure shown here, the right
electrode served as the anode, and the left electrode was the cathode.

The cathode was connected to a second glass tube with the same dimensions as the
first. This tube was connected to the pumping apparatus. It was intended to
electrically isolate the rest of the system so that the only available return
path for the current was through the outer shell.

The cathode was connected to the outer conductor, or ground shell, formed by the
aluminum tube. Additionally, it was connected to the vacuum pump via a glass
tube identical to that used for the discharge. This second glass tube was
intended to isolate cathode such that it was the only available path to
ground.\footnote{While all of the aluminum tube is nominally at ground, it is
likely that it would float to a finite voltage with each pulse.} The ground shell
was held in place against the cathode with a copper shim and a Delrin shaft
collar.

Radial optical access to the discharge was provided by two slots milled into the
ground shell. The slots were positioned on opposite sides of the shell and were
3.8 by 25.4 cm in length. The tube itself was 30 cm in length. The side of the
ground shell not connected to the cathode was connected to a copper sheet, 10 cm
square. The copper sheet was perpendicular to the axis of the discharge tube and
had a 5 cm hole for discharge tube to pass through. The ground shell was
