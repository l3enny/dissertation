...
densities. This causes a further delay in the growth of the electrons.
...
The higher electron density and correspondingly high ionization fraction occur
at the same condition as optimal energy coupling to the plasma, as seen in
Chapter~\ref{chp:experiment}. Simultaneously, as will be seen in
Chapter~\ref{chp:emissions}, the peak metastable density is associated with the
peak brightness of the plasma, the largest number of excited states, and the
highest wave velocity. These contrasting results demonstrate that the \acs{rpnd}
can be optimized for one of two conditions: production of excited atomic states,
or ionization.
