...
initialized with a thermal energy of 0.2 eV, and the helium ions were given an
...
\begin{figure}
  ...
  \label{fig:picmb}
\end{figure}
as a series of contour plots comparing the result for each approach. The
observable jaggedness of the \acs{pic} results stems from the discrete nature of
the system. In the simulations, only a one or two particles might reach the
higher energies where the \acs{eedf} is particularly small. This is most
prevalent at the low electric fields where ionization has not significantly
increased the number of electron macro-particles. 


The observable jaggedness in the \acs{pic}
