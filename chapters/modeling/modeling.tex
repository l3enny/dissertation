...
later in the afterglow. The greatest disagreement between the simulations and
the experiment occur at 1.0 Torr. As will be seen later, the predicted reduced
fields for this condition were the largest, peaking at almost 350 Td. As was
noted in the analysis of the different distributions, this value approaches the
region where the assumption of a Maxwell-Boltzmann distribution begins to fail.

In addition to capturing the behavior during the pulse, the global simulations
show good agreement in the afterglow (around 40 ns after the pulse). 
...
\begin{table}
  ...
  \end{tabular}
\end{table}
summarizes the peak values for several of the plasma parameters from the
simulation.
