...
for a pulse-width that is \emph{longer} than the applied electric field. For the
range of pulse-widths considered, the 40 ns value provides the best match to the
measured metastable data. This result was quite unexpected and suggested an
unknown contribution to the population of the metastable states. Also evident in
the plots

The emissions from the 4$^1$P$^\mathrm{o}$-2$^1$S were measured as a function of
time in order to understand the origin of the extended excitation period of the
metastable states (Chapter~\ref{chp:emissions} provides more detail on the
measurement procedure). Figure~\ref{fig:double}
\begin{figure}
  \centering
  ...
  \label{fig:double}
\end{figure}
shows these emissions for each operating condition overlaid on the applied
voltage pulse. The voltage pulse clearly coincides with the initial excitation
of helium atoms to the 4$^1$P$^\mathrm{o}$ state. Soon after, another increase
in the population of the 4$^1$P$^\mathrm{o}$ state is clearly visible,
particularly at 1.0 and 4.0 Torr. This second burst is similar to the return
strokes observed in early streamer research \cite{Snoddy1936, Loeb1940,
Mitchell1947}. The observation of return strokes in similar, contemporary
studies \cite{Vasilyak1994, Pai2009, Starikovskiy2013} suggests that this is a
reasonable explanation for the double-peaked emissions. Furthermore, the
existence of a return stroke would be a reasonable explanation for the need to
use a pulse-width of 40 ns as compared to the 25 ns width of the applied
voltage pulse.
...
which the electric field must increased grows substantially. Eventually, the
model cannot 

as the
pulse-width is decreased, the strength of the electric field must be increased
to compensate. 
