...
dynamic system which does not necessarily result in an population of electrons
with a Maxwell-Boltzmann distribution. In the absence of this property, the
concept of ``temperature'' is of questionable validity. Often, studies will
resort to effective or mean electron energies, such as those used in
Chapter~\ref{chp:modeling} and the work of Starkovskaia and Starikovskii
\cite{Starikovskaia2001}.

However, the electron temperature, whether it represents a Maxwell-Boltzmann
distribution or a mean energy, is still an important descriptor of the
properties of the \acs{rpnd}. It relates to the magnitude of the applied
electric field, as seen in Chapter~\ref{modeling}, and it can be used to
determine reaction rates within the plasma. For this reason, it is worthwhile to
explore possible means by which the electron temperature may be determined
experimentally.
...
physical probes are not a reasonable option of the \acs{rpnd}. Instead, two
different optical approaches were considered. 
